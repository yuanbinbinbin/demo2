...
import com.base.baselibrary.weights.PinYinTextView;
import com.yb.demo.R;

import java.util.ArrayList;

public class PinyinTextActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pinyin_text);
