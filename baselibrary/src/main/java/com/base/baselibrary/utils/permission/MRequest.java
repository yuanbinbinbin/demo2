...
import com.base.baselibrary.utils.permission.lib.activity.PermissionActivity;
import com.base.baselibrary.utils.permission.lib.checker.CheckerDouble;
import com.base.baselibrary.utils.permission.lib.checker.CheckerPermission;
import com.base.baselibrary.utils.permission.lib.checker.CheckerStandard;
import com.base.baselibrary.utils.permission.lib.inter.Action;
import com.base.baselibrary.utils.permission.lib.inter.Rationale;
import com.base.baselibrary.utils.permission.lib.inter.Request;
import com.base.baselibrary.utils.permission.lib.inter.RequestExecutor;
...
class MRequest implements Request, RequestExecutor, PermissionActivity.PermissionListener {
    ...
    private static final CheckerPermission CHECKER = new CheckerStandard();
    private static final CheckerPermission DOUBLE_CHECKER = new CheckerDouble();
     ...
     */
    private static List<String> getDeniedPermissions(CheckerPermission checker, @NonNull Source source, @NonNull String... permissions) {
