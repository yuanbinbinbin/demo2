 ...
 */
public final class CheckerDouble implements CheckerPermission {

    private static final CheckerPermission STANDARD_CHECKER = new CheckerStandard();
    private static final CheckerPermission STRICT_CHECKER = new CheckerStrict();
