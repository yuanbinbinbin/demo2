...
//        mUnderlinePaint.setPathEffect(new DashPathEffect(new float[]{2, 2, 2, 2}, 0));
    ...
    public PinYinTextView setTextColor(@ColorInt int mTextColor) {
    ...
    public PinYinTextView setTextColor(int position, @ColorInt int mTextColor) {
    ...
    public PinYinTextView setAllTextColor(@ColorInt int mTextColor) {
    ...
    public PinYinTextView setPinyinColor(@ColorInt int mPinyinColor) {
    ...
    public PinYinTextView setPinyinColor(int position, @ColorInt int mPinyinColor) {
        if (mData.size() > 0 && mData.size() > position) {
    ...
    public PinYinTextView setAllPinyinColor(@ColorInt int mPinyinColor) {
        for (int i = 0; i < mData.size(); i++) {
            PinyinBean word = mData.get(i);
            word.pinyinColor = 0;
        }
...
//            Log.e("test", hanzi.length() + " : " + splitPinyin.length);
    ...
    public static class PinyinBean {
        ...
        public static PinyinBean create(String text, @ColorInt int textColor, String pinyin, @ColorInt int pinyinColor) {
